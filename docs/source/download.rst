  ...
  .. tab-item:: Windows
    ...
    .. grid:: 1 1 2 2
      ...
      .. grid-item-card::  Beta
        ...
        .. button-link:: https://github.com/psychopy/psychopy/releases/download/2025.1.1/StandalonePsychoPy-2025.1.1-win-py3.10.exe
          :color: primary
        ...
        .. dropdown:: Compatibility+ installer (py3.8)
          ...
          .. button-link:: https://github.com/psychopy/psychopy/releases/download/2025.1.1/StandalonePsychoPy-2025.1.1-win-py3.8.exe
            :color: primary
